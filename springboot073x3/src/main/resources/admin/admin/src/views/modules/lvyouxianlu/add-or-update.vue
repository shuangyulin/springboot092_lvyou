<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="线路规划" prop="xianluguihua">
          <el-input v-model="ruleForm.xianluguihua" 
              placeholder="线路规划" clearable  :readonly="ro.xianluguihua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="线路规划" prop="xianluguihua">
              <el-input v-model="ruleForm.xianluguihua" 
                placeholder="线路规划" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.xianlutupian" label="线路图片" prop="xianlutupian">
          <file-upload
          tip="点击上传线路图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xianlutupian" label="线路图片" prop="xianlutupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xianlutupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.youkexingming = true;
          ...
          if(o=='xianluguihua'){
            this.ruleForm.xianluguihua = obj[o];
	    this.ro.xianluguihua = true;
            continue;
          }
          if(o=='xianlutupian'){
