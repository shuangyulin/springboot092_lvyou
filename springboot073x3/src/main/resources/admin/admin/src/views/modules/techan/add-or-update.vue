<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所在省区" prop="suozaishengqu">
          <el-select v-model="ruleForm.suozaishengqu" placeholder="请选择所在省区">
            <el-option
                v-for="(item,index) in suozaishengquOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所在城市" prop="suozaichengshi">
          <el-select v-model="ruleForm.suozaichengshi" placeholder="请选择所在城市">
            <el-option
                v-for="(item,index) in suozaichengshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="所在地区" prop="suozaidiqu">
          <el-select v-model="ruleForm.suozaidiqu" placeholder="请选择所在地区">
            <el-option
                v-for="(item,index) in suozaidiquOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="特产介绍" prop="techanjieshao">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.techanjieshao" label="特产介绍" prop="techanjieshao">
                    <span>{{ruleForm.techanjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `techan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.techanCrossAddOrUpdateFlag = false;
                  this.parent.search();
