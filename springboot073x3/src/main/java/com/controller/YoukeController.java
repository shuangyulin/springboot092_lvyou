...
public class YoukeController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YoukeEntity user = youkeService.selectOne(new EntityWrapper<YoukeEntity>().eq("youkezhanghao", username));
    ...
    public R register(@RequestBody YoukeEntity youke){
    	...
    	YoukeEntity user = youkeService.selectOne(new EntityWrapper<YoukeEntity>().eq("youkezhanghao", youke.getYoukezhanghao()));
		if(user!=null) {
