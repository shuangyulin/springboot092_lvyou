<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="游客账号" prop="youkezhanghao">
          <el-input v-model="ruleForm.youkezhanghao" 
              placeholder="游客账号" clearable  :readonly="ro.youkezhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="游客账号" prop="youkezhanghao">
              <el-input v-model="ruleForm.youkezhanghao" 
                placeholder="游客账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="游客姓名" prop="youkexingming">
          <el-input v-model="ruleForm.youkexingming" 
              placeholder="游客姓名" clearable  :readonly="ro.youkexingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="游客姓名" prop="youkexingming">
              <el-input v-model="ruleForm.youkexingming" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="特产名称" prop="techanmingcheng">
          <el-input v-model="ruleForm.techanmingcheng" 
              placeholder="特产名称" clearable  :readonly="ro.techanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="特产名称" prop="techanmingcheng">
              <el-input v-model="ruleForm.techanmingcheng" 
                placeholder="特产名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在省区" prop="suozaishengqu">
          <el-input v-model="ruleForm.suozaishengqu" 
              placeholder="所在省区" clearable  :readonly="ro.suozaishengqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在省区" prop="suozaishengqu">
              <el-input v-model="ruleForm.suozaishengqu" 
                placeholder="所在省区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="数目" prop="shumu">
          <el-input v-model="ruleForm.shumu" 
              placeholder="数目" clearable  :readonly="ro.shumu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="数目" prop="shumu">
              <el-input v-model="ruleForm.shumu" 
                placeholder="数目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  computed: {
    zongjine:{
      get: function () {
        return 1*this.ruleForm.shumu*this.ruleForm.jiage
      }
    },
  },
  created() {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='youkezhanghao'){
            this.ruleForm.youkezhanghao = obj[o];
	    this.ro.youkezhanghao = true;
            continue;
          }
          if(o=='youkexingming'){
            this.ruleForm.youkexingming = obj[o];
	    this.ro.youkexingming = true;
            continue;
          }
          if(o=='lianxifangshi'){
	    ...
	    this.ro.techanmingcheng = true;
          ...
          if(o=='suozaishengqu'){
            this.ruleForm.suozaishengqu = obj[o];
	    this.ro.suozaishengqu = true;
            continue;
          }
          if(o=='suozaichengshi'){
	...
	this.ro.shumu = false;
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.youkezhanghao!=''&&json.youkezhanghao){
              		this.ruleForm.youkezhanghao = json.youkezhanghao
		}
		if(json.youkexingming!=''&&json.youkexingming){
              		this.ruleForm.youkexingming = json.youkexingming
		}
    ...
    onSubmit() {
      ...
      if(obj!=null) {
	      obj.shumu = obj.shumu - this.ruleForm.shumu
	      if(obj.shumu<0){
		this.$message.error("数目不足");
		return
	      }
	      this.$http({
		  url: `${table}/update`,
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `techandingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.techandingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
